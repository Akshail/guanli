<%@ Page Title="" Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="NoticeManage_Add.aspx.cs" Inherits="XF.HKHJXT.Administrator.NoticeManage_Add" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: left; background-color: rgb(238, 238, 238); border: 1px solid #666;">
                        <input id="input_ShowTime" runat="server" style="width: 35%" type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy年MM月dd日 HH:mm:ss'})" />
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td style="text-align: center; width: 20%">
                        <asp:Button ID="btn_Add" runat="server" Text="发布" OnClick="btn_Add_Click" CssClass="button button-rounded button-flat-primary button-tiny" />
                        <td style="text-align: center; width: 20%">
