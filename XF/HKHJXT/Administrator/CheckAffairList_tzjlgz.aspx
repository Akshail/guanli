            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: right">
                        <asp:Label runat="server" ID="Label1">项目交流工作信息 共找到</asp:Label>
                    ...
                    <td>
                        <asp:GridView ID="gv_Result" runat="server" class="tableclass" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CommunicationTypeId" HeaderText="交流校区">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="GroupArea" HeaderText="所属学院">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="GroupName" HeaderText="项目名称">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="GroupMonitor" HeaderText="项目组长">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
