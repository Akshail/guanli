<%@ Page Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master"  AutoEventWireup="true" CodeBehind="CollegeManage.aspx.cs" Inherits="XF.HKHJXT.Administrator.CollegeManage" %>
    ...
    <script type="text/javascript">
        function btn_addUser_click(userid) {
            $.layer({
                ...
                fix: false,
                title: ['添加学院', true],
                iframe: { src: 'CollegeManage_Add.aspx?UserId=' + userid },//写一个网页
                area: ['550px', '200px'],
                offset: ['150px', ''],
                end: function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubMenu" runat="server">
    <div class="content1">
        <div class="maincontent" style="padding-top: 27px;">
            <div id="navcontainer">          
                <asp:Label runat="server" ID="description">学院管理说明：<br />&nbsp&nbsp&nbsp&nbsp 学院列表默认展示所有学院信息。可根据学院名字进行搜索。<br />&nbsp&nbsp&nbsp&nbsp点击“修改”可修改学院信息。点击“删除”可删除学院。</asp:Label>
            </div>
        </div>
    </div>
</asp:Content>
        ...
        <div class="maincontent">
            <table style="width: 100%" class="table_search">
                <tr>
                    ...
                    <td style="width: 10%; text-align: right">
                    <asp:Button ID="btn_Add" runat="server" Text="新增学院" CssClass="button button-rounded button-flat-action button-tiny" OnClick="btn_Add_Click" />
                    </td>
                </tr>
            </table>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gv_Vip" runat="server" class="tableclass" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="SchoolName" HeaderText="学院名">
                                <ItemStyle HorizontalAlign="Center" Width="150px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="SchoolCode" HeaderText="学院代码">
                                <ItemStyle HorizontalAlign="Center" Width="150px" />
                            </asp:BoundField>
