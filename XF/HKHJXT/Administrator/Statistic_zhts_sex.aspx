<%@ Page Title="" Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="Statistic_zhts_sex.aspx.cs" Inherits="XF.HKHJXT.Administrator.Statistic_zhts_sex" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHMainContent" runat="server">
    ...
    <div class="content2">
        <h2 class="title2">在校本科生信息 - 性别统计</h2>
        <div class="maincontent">
            ...
            <div style="width: 778px; margin-top: 10px; text-align: center">
                <asp:Label runat="server" ID="label_head" Text="全体在校本科生性别统计" CssClass="statistic_head" />
            </div>
