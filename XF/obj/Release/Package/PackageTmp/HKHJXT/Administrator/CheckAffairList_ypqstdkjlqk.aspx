<%@ Page Title="" Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="CheckAffairList_ypqstdkjlqk.aspx.cs" Inherits="XF.HKHJXT.Administrator.CheckAffair_ypqstdkjldq" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHMainContent" runat="server">
    ...
    <div class="content2">
        <h2 class="title2">对口地区里长交流工作信息</h2>
        <div class="maincontent">
            ...
            <table style="width: 100%" class="table_search">
                <tr>
                    ...
                    <%--<td class="Search">交流地区：
                    </td>
                    <td >
                        <asp:TextBox ID="tb_Area" runat="server" Width="95%"></asp:TextBox>
                    </td>--%>
                    <td></td>
                    <td>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: right">
                        <asp:Label runat="server" ID="Label1">对口地区里长交流工作信息 共找到</asp:Label>
                    ...
                    <td>
                        <asp:GridView ID="gv_Result" runat="server" class="tableclass" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <%--<asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="Link_update" runat="server" CommandName="Upd" CommandArgument='<%#Eval("Id") %>'>修改</asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="10%" />
                                </asp:TemplateField>--%>
                                <asp:TemplateField HeaderText="操作">
