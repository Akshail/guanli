...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHMainContent" runat="server">
    ...
    <div class="content2">
        <h2 class="title2">在沪台生信息 - 学校分布统计</h2>
        <div class="maincontent">
            ...
            <div style="width: 778px; margin-top: 10px; text-align: center">
                <asp:Label runat="server" ID="label_head" Text="全体在读台生学校分布统计" CssClass="statistic_head" />
            </div>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gv_result" runat="server" class="tableclass" AutoGenerateColumns="false"
                            ...
                            AllowPaging="false">
                            <Columns>
                                <asp:BoundField DataField="ItemName" HeaderText="学校名称">
