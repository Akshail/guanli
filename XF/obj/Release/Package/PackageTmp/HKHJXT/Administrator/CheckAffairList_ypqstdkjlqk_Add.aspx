<%@ Page Title="" Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="CheckAffairList_ypqstdkjlqk_Add.aspx.cs" Inherits="XF.HKHJXT.Administrator.CheckAffairList_ypqstdkjlqk_Add" %>
            ...
            <div id="navcontainer">
                ...
                <div id="toolbar" style="position: fixed; text-align: left">
                    ...
                    <asp:Label ID="label_des" runat="server" Style="-ms-word-break: break-all; word-break: break-all; -ms-word-wrap: break-word; word-wrap: break-word">
                        说明：<br />
                        &nbsp&nbsp&nbsp系统管理员可针对对口地区里长交<br />流工作信息进行修改。只需修改信息内<br />容后，点击"确认修改"即可。</asp:Label>
                    <br />
                    <br />
                    <br />
                    &nbsp&nbsp
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHMainContent" runat="server">
    <div class="content2">
        <h2 class="title2">新增对口地区里长交流工作信息</h2>
        <div class="maincontent">
            ...
            <table style="width: 100%; border: 1px solid #666; border-spacing: 0px; border-collapse: collapse">
                ...
                <tr>
                    <td class="auto-style5">里干事：</td>
                    <td class="auto-style4">

                        <asp:TextBox ID="tb_Servant" runat="server" Width="100%" Height="100%" BorderStyle="None"></asp:TextBox>
                    </td>
                    <td class="auto-style5">里干事联系电话：</td>
                    <td class="auto-style4">

                        <asp:TextBox ID="tb_phoneNoOfS" runat="server" Width="100%" Height="100%" BorderStyle="None"></asp:TextBox>
                    </td>
                </tr>
                <tr>
