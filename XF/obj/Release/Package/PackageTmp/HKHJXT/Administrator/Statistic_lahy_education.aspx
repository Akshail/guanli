<%@ Page Title="" Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="Statistic_lahy_education.aspx.cs" Inherits="XF.HKHJXT.Administrator.Statistic_lahy_education" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            var array_first = $($(".menu-left").get(1)).children().first().siblings().show();//显示两岸婚姻
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHMainContent" runat="server">
    ...
    <div class="content2">
        <h2 class="title2">两岸婚姻信息 - 学历统计</h2>
        <div class="maincontent">
            ...
            <table style="width: 100%" class="table_search">
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <td style="width: 85px">结婚年份：
                    </td>
                    <td style="width: 170px">
                        <input id="tb_marrage_start" runat="server" type="text" style="width: 70px" class="Wdate" errdealmode="0" onfocus="WdatePicker({dateFmt:'yyyy'})" />
                        -
                        <input id="tb_marrage_end" runat="server" type="text" style="width: 70px" class="Wdate" errdealmode="0" onfocus="WdatePicker({dateFmt:'yyyy'})" />
                    </td>
                    <td>
                        <asp:Button ID="btn_Search" runat="server" Width="60" Text="搜索" OnClick="btn_Search_Click" CssClass="button button-rounded button-flat-primary button-tiny" />
                    </td>
                    <td></td>
                </tr>
            </table>
            ...
            <div style="width: 778px; margin-top: 10px; text-align: center">
                <asp:Label runat="server" ID="label_head" Text="全体两岸婚姻台籍性别统计" CssClass="statistic_head" />
            </div>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gv_result" runat="server" class="tableclass" AutoGenerateColumns="false"
                            ...
                            AllowPaging="false">
                            <Columns>
                                <asp:BoundField DataField="ItemName" HeaderText="学历">
