<%@ Page Title="" Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="Statistic_lahy_sex_tai.aspx.cs" Inherits="XF.HKHJXT.Administrator.Statistic_lahy_sex_tai" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHMainContent" runat="server">
    ...
    <div class="content2">
        <h2 class="title2">两岸婚姻信息 - 台籍性别统计</h2>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gv_result" runat="server" class="tableclass" AutoGenerateColumns="false"
                            ...
                            AllowPaging="false">
                            <Columns>
                                <asp:BoundField DataField="ItemName" HeaderText="台籍性别">
