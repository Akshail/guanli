<%@ Page Title="" Language="C#" MasterPageFile="~/HKHJXT/Administrator/Admin.Master" AutoEventWireup="true" CodeBehind="CheckAffairList_zdtsqk.aspx.cs" Inherits="XF.HKHJXT.Administrator.CheckAffairList_zdtsqk" %>
        ...
        <div class="maincontent">
            ...
            <table style="width: 100%;" class="table_search">
                    ...
                    <td style="width: 190px">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <%--<asp:Button ID="btn_Import" runat="server" Text="导入" OnClientClick="CPHMainContent_file_upload.click()" CssClass="button button-rounded button-flat-action button-tiny" />--%>
                ...
                <tr style="line-height: 30px">
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddl_School" Width="165" />
                    </td>
                    <td>
                        <asp:Button ID="btn_Search" runat="server" Text="搜索" OnClick="btn_Search_Click" CssClass="button button-rounded button-flat-primary button-tiny" />
                    </td>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: right">
                        <asp:Label runat="server" ID="Label1">在沪台生信息 共找到</asp:Label>
                    ...
                    <td>
                        <asp:GridView ID="gv_Result" runat="server" class="tableclass" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="School" HeaderText="就读学校">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <%--<asp:BoundField DataField="CreateTime" HeaderText="专业">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>--%>
                                <asp:BoundField DataField="PhoneNo" HeaderText="联系电话">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:HyperLinkField HeaderText="操作" Text="查看/修改" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="CheckAffairList_zdtsqk_Add.aspx?Id={0}">
